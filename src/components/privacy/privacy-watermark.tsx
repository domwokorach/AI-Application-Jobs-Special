...
export function PrivacyWatermark({ actorId, timestamp }: PrivacyWatermarkProps) {
  ...
  return (
    <div aria-hidden="true" className="pointer-events-none absolute inset-0 z-10 grid grid-cols-2 content-around overflow-hidden opacity-20 sm:grid-cols-3 lg:grid-cols-4">
